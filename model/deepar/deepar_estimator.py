...
from model import PTSEstimator, Predictor, PTSPredictor, copy_parameters
from modules import DistributionOutput, StudentTOutput
...
class DeepAREstimator(PTSEstimator):
    ...
    def create_predictor(
        ...
        return PTSPredictor(
            ...
            device=device,
            dtype=self.dtype,
            #forecast_generator = SampleForecastGenerator() # [Note] Default is sampling forecaster
        )
